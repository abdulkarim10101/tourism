        ...
        <div class="my-4 my-xl-8">
            <div class="row">
                <div class="col-md-5 ml-xl-auto mr-md-auto mr-xl-0 mb-8 mb-md-0">
                    ...
                    <!-- End Title -->
                    <form class="js-validate" novalidate="novalidate" method="post" action="{{ route('customer.login') }}">
                        <!-- Form Group -->
                        @csrf
                ...
                <div class="col-md-5 ml-md-auto ml-xl-0 mr-xl-auto">
                    ...
                    <!-- End Title -->
                    <!-- Form Group -->
                    <form class="js-validate" novalidate="novalidate" method="post" action="{{ route('customer.signup') }}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="js-form-message form-group mb-5">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="RegisterSrEmailExample3" placeholder="First Name" aria-label="Email address" required />
                                </div>

                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="js-form-message form-group mb-5">
                                <label class="form-label" for="RegisterSrEmailExample3">Last Name
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" class="form-control" name="last_name" id="RegisterSrEmailExample3" placeholder="Last Name" aria-label="Email address" required />
                            </div>
                        </div>

                        </div>
                        <div class="js-form-message form-group mb-5">
                            <label class="form-label" for="RegisterSrEmailExample3">Contact
                                <span class="text-danger">*</span>
                            </label>
                            <input type="number" class="form-control" name="phone" id="RegisterSrEmailExample3" placeholder="Phone" aria-label="Email address" required />
                        </div>
                        <div class="js-form-message form-group mb-5">
                        ...
                        <div class="js-form-message form-group mb-5">
                            ...
                            <input type="password" class="form-control" name="password" id="RegisterSrEmailExample3" placeholder="Enter Password" aria-label="Email address" required
                            data-msg="Please enter a valid email address."
                            data-error-class="u-has-error"
                            data-success-class="u-has-success">
                        </div>
                        {{-- <div class="js-form-message form-group mb-5">
                            ...
                            <input type="email" class="form-control" name="phone" id="RegisterSrEmailExample3" placeholder="Email address" aria-label="Email address" required
                            data-msg="Please enter a valid email address."
                            data-error-class="u-has-error"
                            data-success-class="u-has-success">
                        </div>
                        <div class="js-form-message form-group mb-5">
                            ...
                            <textarea class="form-control" name="primary_address" id="" cols="30" rows="6"></textarea>
                        </div> --}}
                        <!-- End Form Group -->
