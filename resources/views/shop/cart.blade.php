                                    ...
                                    <div class="pt-md-3">
                                        <div class="d-block d-md-flex flex-center-between">
                                            <div class="mb-3 mb-md-0 w-xl-40">
                                                <!-- Apply coupon Form -->
                                                <div class="couponForm" @if (Session::has('coupon_code')) style="display: none;" @endif>
                                                ...
                                                <div class="couponDiv" @if (!Session::has('coupon_code')) style="display: none;" @endif>
                                                    <div id="shopCartHeadingTwo" class="alert alert-primary mb-0 mt-4"
                                                        role="alert">
                                                    <strong id="coupontext">Coupon "{{ Session::has('coupon_code') ? Session::get('coupon_code') : '' }}" Applied</strong>
                                                    </div>
                                                </div>
                        ...
                        <table class="table mb-3 mb-md-0">
                            <tbody>
                                <tr class="cart-subtotal">
                                    <th>Subtotal</th>
                                    <td data-title="Subtotal">AED <span class="amount subtotal1">{{ $totals }}</span></td>
                                </tr>
                                <tr class="cart-subtotal">
                                    <th>Discount</th>
                ...
                success: function(response) {
                    ...
                    if (response.message == 'Coupon Applied') {
                        ...
                        $('#coupontext').text('Congratulations Promo Code Applied ' + response.percentage +
                            ...
                            afterdiscount=parseInt($('#total1').text())-((5/100)*parseInt($('#total1').text()))
