...
$featuredproducts = Product::where('featured',1)->limit(9)->get();
@endphp
                    ...
                    <div class="row align-items-center">
                                    ...
                                    <ul class="navbar-nav u-header__navbar-nav">
                                        ...
                                        <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover"
                                            ...
                                            <!-- <ul id="HomeSubMenu" class="hs-sub-menu u-header__sub-menu animated fadeOut" aria-labelledby="HomeMegaMenu" style="min-width: 230px; display: none;">
                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="/">Home v1</a></li>
                                        ...
                                        <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="click"
                                            ...
                                            <div class="hs-mega-menu w-100 u-header__sub-menu"
                                                ...
                                                <div class="row u-header__mega-menu-wrapper">
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="u-header__sub-menu-title">Categories</span>
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="../shop/product-categories.html"
                                                                    class="nav-link u-header__sub-menu-nav-link">Categories
                                                                    1</a></li>
                                                            <li><a href="../shop/product-categories.html"
                                                                    class="nav-link u-header__sub-menu-nav-link">Categories
                                                                    2 </a></li>
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="u-header__sub-menu-title">Product</span>
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="../shop/single-product.html"
                                                                    class="nav-link u-header__sub-menu-nav-link">Product
                                                                    1</a></li>
                                                            <li><a href="../shop/single-product.html"
                                                                    class="nav-link u-header__sub-menu-nav-link">Product
                                                                    2 </a></li>
                                        ...
                                        <li class="nav-item u-header__nav-item">
                                            <a class="nav-link u-header__nav-link" href="../about/">About
                                                us</a>
                                        </li>
                                        <!-- End About us -->
                                        ...
                                        <!-- Contact Us -->
                                        <li class="nav-item u-header__nav-item">
                                            <a class="nav-link u-header__nav-link" href="../contact/">Contact
                                                Us</a>
                                        </li>
                                        <!-- End Contact Us -->
                                    </ul>
                        ...
                        <div class="d-none d-xl-block col-md-auto">
                            <div class="d-flex">
                                ...
                                <div class="ml-2">
                                    <div class="phone">
                                        <strong>Support</strong> <a href="tel:800856800604"
                                            class="text-gray-90">(+800) 856 800 604</a>
                                    </div>
                                    <div class="email">
                                ...
                                <ul class="d-flex list-unstyled mb-0">
                                    ...
                                    <li class="col pr-0">
                                        <a href="{{route('cart.index')}}" class="text-gray-90 position-relative d-flex "
                                            ...
                                            <i class="font-size-22 ec ec-shopping-bag"></i>
                                            <span
                                                class="width-22 height-22 bg-dark position-absolute flex-content-center text-white rounded-circle left-12 top-8 font-weight-bold font-size-12">{{Session::has('cart') ? Session::get('cart')->totalQty : ''}}</span>
                                            <span
                                                class="font-weight-bold font-size-16 text-gray-90 ml-3">${{Session::has('cart') ? Session::get('cart')->totalPrice : ''}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
