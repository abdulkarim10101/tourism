        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <div class="col-md-8">
                        <form action="{{ route('promocodes.update',$promocode->id) }}" method="POST" class="form-horizontal"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" class="form-control" name="expiry_date" id="inputPassword3"
                                            placeholder="Password" value="{{$promocode->expiry_date}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="name"
                                            placeholder="Enter Text" value="{{$promocode->name}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Discount Percentage</label>
                                    <div class="col-sm-8">
                                        <input type="number" value="{{$promocode->percentage}}" class="form-control" name="percentage"
