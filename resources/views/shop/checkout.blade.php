                        ...
                        <div class="pb-7 mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="js-form-message mb-6">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control p-5" cols="80" rows="4" name="primary_address"
                            ...
                            @else
                                ...
                                <div id="shopCartAccordion3" class="accordion rounded mb-5">
                                    ...
                                    <div class="card border-0">
                                            ...
                                            @if (auth()->user()->primary_address != null)
                                                <div id="shopCartHeadingFour" class=" custom-checkbox align-items-center">
                                                    <label class="form-label" for="shippingdiffrentAddress"
                                                        data-toggle="collapse" data-target="#shopCartfour"
                                                        aria-expanded="false" aria-controls="shopCartfour">
                                                        Primary Address:
                                                    </label>
                                        ...
                                        @if (auth()->user()->primary_address != null)
                                            <div id="shopCartHeadingFour"
                                                ...
                                                <input type="checkbox" class="custom-control-input"
                                                    id="shippingdiffrentAddress" name="shippingdiffrentAddress">
                                                <label class="custom-control-label form-label"
                                                    for="shippingdiffrentAddress" data-toggle="collapse"
                                                    data-target="#shopCartfour" aria-expanded="false"
                                        ...
                                        @endif
                                        <div id="shopCartfour"
                                            class="@if (auth()->user()->primary_address != null) collapse @endif mt-5"
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <div class="input-group">
                                                    <textarea class="form-control p-5" rows="4" @if (auth()->user()->primary_address == null) required @endif
                                                        name="new_address" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                                                </div>
                                            </div>
                                            <!-- End Shipping Form -->
                                        </div>
                            ...
                            {{-- <div id="shopCartAccordion2" class="accordion rounded mb-6">
                                ...
                                <div class="card border-0">
                                    ...
                                    <div id="shopCartThree" class="" aria-labelledby="shopCartHeadingThree" data-parent="#shopCartAccordion2" style="">
                                        <!-- Form Group -->
