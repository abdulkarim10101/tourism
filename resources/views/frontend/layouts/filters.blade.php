<div class="mb-6">
    ...
    <div class="border-bottom pb-4 mb-4 d-none">
    ...
    <div class="range-slider">
        ...
        <input class="js-range-slider" type="text"
            ...
            data-grid="false" data-hide-from-to="true" data-prefix="$" data-min="0" data-max="99999" data-from="0"
            data-to="99999" data-result-min="#rangeSliderExample3MinResult"
            data-result-max="#rangeSliderExample3MaxResult" name="minmax">
        <!-- End Range Slider -->
