            ...
            <div class="filtersdiv">
                ...
                <div class="filters row" style="display:none">
                    ...
                    {{-- <div class="col-md-0 mx-3 my-3">
                            ...
                            <a href="{{ route('vendors.index') }}"><button type="button"
            ...
            <div class="row mb-2">
                ...
                <div class=" offset-sm-2  col-sm-2">
                    <h1 class="float-sm-right"><span id="total"
                            class="badge badge-pill total">{{ $vendors->total() }}</span></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="align-items: center;">
                                ...
                                <a class="addbutton" href="{{ route('vendors.create') }}"><button type="button"
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                @include('admin.vendor.usertable')
                            </tbody>
                        </table>
