                        ...
                        <form action="{{ route('vendors.store') }}" method="POST" class="form-horizontal"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required type="text" name="website_url" class="form-control">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required type="text" name="bank_account_name" class="form-control">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required type="text" name="bank_account_number" class="form-control">
                                    </div>
