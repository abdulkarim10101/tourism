                ...
                <div class="card border-0">
                    @if (auth()->user() == null)
                        <div id="shopCartHeadingOne" class="alert alert-primary mb-0" role="alert">
                            Returning customer? <a href="{{ route('customer.getLogin') }}" class="alert-link">Click here to
                                login</a>
                        </div>
                    @endif
                    @if ($errors->any())
                    ...
                    <div id="shopCartOne" class="collapse border border-top-0" aria-labelledby="shopCartHeadingOne"
                        ...
                        <form class="js-validate p-5">
                            ...
                            <div class="mb-5">
                                ...
                                <p class="text-gray-90">If you have shopped with us before, please enter your details
            ...
            <div id="shopCartAccordion1" class="accordion rounded mb-6">
                ...
                <div class="card border-0">
                    ...
                    Have a coupon? <a href="#" class="alert-link" data-toggle="collapse" data-target="#shopCartTwo"
                        aria-expanded="false" aria-controls="shopCartTwo">Click here to enter your code</a>
                </div> --}}
                        ...
                        <div class="pl-lg-3 ">
                            <div class="bg-gray-1 rounded-lg">
                                ...
                                <div class="p-4 mb-4 checkout-table">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($products as $key => $item)
                                                <tr class="cart_item">
                                                    <td>{{ $item['item']['name'] }}&nbsp;<strong class="product-quantity">×
                                                            {{ $item['qty'] }}</strong></td>
                                        ...
                                        <tfoot>
                                            @if (Session::get('coupon_percentage') != null)
                                                <tr>
                                                    <th>Discount</th>
                                                    <td><strong>{{ Session::has('coupon_percentage') ? Session::get('coupon_percentage') : '0' }}%</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Total</th>
                                                    <td><strong>AED
                                                            {{ $totals - (Session::get('coupon_percentage') / 100) * $totals }}</strong>
                                                    </td>
                                                </tr>
                                            @else
                                                <tr>
                                    ...
                                    <button type="submit" class="btn btn-dark btn-block btn-pill font-size-20 mb-3 py-3">Place
                                        order</button>
                                </div>
                                <!-- End Order Summary -->
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" name="last_name" placeholder="Wayley"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" class="form-control" name="city" placeholder="London"
                                                aria-label="London" required="" data-msg="Please enter a valid city."
                                                data-error-class="u-has-error" data-success-class="u-has-success"
                                                value="{{ old('city') }}">
                                        </div>
                                        <!-- End Input -->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="number" class="form-control" name="postal_code" placeholder="99999"
                                                aria-label="99999" required="" data-msg="Please enter a valid postcode or zip code."
                                                data-error-class="u-has-error" data-success-class="u-has-success"
                                                value="{{ old('postal_code') }}">
                                            <input type="hidden" class="form-control" name="method" value="cash">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="password" class="form-control" name="password"
                                                id="signinSrPasswordExample1" placeholder="********" aria-label="********"
                                                required data-msg="Enter password." data-error-class="u-has-error"
                                                data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    <div class="js-form-message mb-6">
                                        ...
                                        <div class="input-group">
                                            <textarea required class="form-control p-5" cols="80" rows="4" name="primary_address"
                                                placeholder="Address">{{ old('primary_address') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="js-form-message mb-6">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control p-5" cols="80" rows="4" name="order_notes"
                                    ...
                                    <div class="card border-0">
                                        @if (auth()->user() != null)
                                            ...
                                            @if (auth()->user()->primary_address != null)
                                                <div id="shopCartHeadingFour" class=" custom-checkbox align-items-center">
                                                    <label class="form-label" for="shippingdiffrentAddress"
                                        ...
                                        @endif
                                        <div id="shopCartfour" class="@if (auth()->user()->primary_address != null) collapse @endif mt-5"
                                            aria-labelledby="shopCartHeadingFour" data-parent="#shopCartAccordion3"
                                            style="">
                                            <!-- Shipping Form -->
                                            <div class="js-form-message mb-6">
                                                <label class="form-label">
                                                ...
                                                <div class="input-group">
                                                    <textarea class="form-control p-5" cols="80" rows="4" name="shipping_address"
